...
- [#219](https://github.com/baseballyama/postgresql-eslint-parser/pull/219) [`e61deb4`](https://github.com/baseballyama/postgresql-eslint-parser/commit/e61deb4997aa69426737b59bae4ec0bf5cffb3a2) Thanks [@baseballyama](https://github.com/baseballyama)! - Fix `Alias` node detection and per-name `range` resolution for `colnames`.
